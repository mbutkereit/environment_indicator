...
/**
 * @file
 * Contains \Drupal\environment_indicator\EnvironmentListController.
 */
 ...
 */
class EnvironmentListController extends ConfigEntityListController implements FormInterface {
  /**
   * {@inheritdoc}
   */
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    // Add weight column.
    /*
      TODO Make draggable weights to work.
    */
    $row['weight'] = array(
      '#type' => 'weight',
