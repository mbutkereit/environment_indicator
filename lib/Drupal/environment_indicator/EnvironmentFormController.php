...
class EnvironmentFormController extends EntityFormController {
  /**
  ...
  public function delete(array $form, array &$form_state) {
    ...
    $form_state['redirect'] = array('admin/config/development/environment-indicator/' . $entity->id() . '/delete', array('query' => $destination));
  }
